...
let o$3 = class o {
    ...
    get styleSheet()
    {
        ...
        if (e$2 && void 0 === t) {
            ...
            e && (t = n$3.get(s)),
            void 0 === t && ((this.o = t = new CSSStyleSheet).replaceSync(this.cssText), e && n$3.set(s, t));
        }
        return t
    }
    toString()
...
let u$1 = class u extends HTMLElement {
    ...
    {
        let e = !0;
        void 0 !== t && (((s = s || this.constructor.getPropertyOptions(t)).hasChanged || a$1)(this[t], i) ? (this._$AL.has(t) || this._$AL.set(t, i), !0 === s.reflect && this._$El !== t && (void 0 === this._$EC && (this._$EC = new Map), this._$EC.set(t, s))) : e = !1),
    ...
    performUpdate()
    {
        ...
        if (!this.isUpdatePending)
            return;
        this.hasUpdated,
        this._$Ei && (this._$Ei.forEach(((t, i) => this[i] = t)), this._$Ei = void 0);
        let i = !1;
        const s = this._$AL;
        try {
            i = this.shouldUpdate(s),
            i ? (this.willUpdate(s), null === (t = this._$ES) || void 0 === t || t.forEach((t => {
                var i;
...
u$1.elementStyles = [],
u$1.shadowRootOptions = {
    mode: "open"
},
null == o$2 || o$2({
    ReactiveElement: u$1
}),
(null !== (s$2 = e$1.reactiveElementVersions) && void 0 !== s$2 ? s$2 : e$1.reactiveElementVersions = []).push("1.6.2");
...
const V = (t, i) => {
    ...
    for (let i = 0; i < s; i++) {
        ...
        for (; a < s.length && (u.lastIndex = a, c = u.exec(s), null !== c);)
            a = u.lastIndex,
            u === f ? "!--" === c[1] ? u = _ : void 0 !== c[1] ? u = m : void 0 !== c[2] ? (y.test(c[2]) && (l = RegExp("</" + c[2], "g")), u = p) : void 0 !== c[3] && (u = p) : u === p ? ">" === c[0] ? (u = null != l ? l : f, v = -1) : void 0 === c[1] ? v = -2 : (v = u.lastIndex - c[2].length, d = c[1], u = void 0 === c[3] ? p : '"' === c[3] ? $ : g) : u === $ || u === g ? u = p : u === _ || u === m ? u = f : (u = p, l = void 0);
            ...
            if (1 === h.nodeType) {
                if (h.hasAttributes()) {
                    ...
                    for (const i of h.getAttributeNames())
                        if (i.endsWith(o$1) || i.startsWith(n$1)) {
                            const s = f[d++];
                ...
                if (h.data === l$1)
                    ...
                    let t = -1;
                    for (; -1 !== (t = h.data.indexOf(n$1, t + 1));)
                        v.push({
                            type: 7,
                            index: r
                        }),
...
class M {
    ...
    {
        var i;
        const {el: {content: s}, parts: e} = this._$AD,
        ...
        for (; void 0 !== u;) {
            if (l === u.index) {
                let i;
                2 === u.type ? i = new R(n, n.nextSibling, this, t) : 1 === u.type ? i = new u.ctor(n, u.name, u.strings, this, t) : 6 === u.type && (i = new Z(n, this, t)),
                this._$AV.push(i),
                u = e[++h];
            }
...
class R {
    ...
    {
        t = S(this, t, i),
        d(t) ? t === A || null == t || "" === t ? (this._$AH !== A && this._$AR(), this._$AH = A) : t !== this._$AH && t !== T && this._(t) : void 0 !== t._$litType$ ? this.g(t) : void 0 !== t.nodeType ? this.$(t) : v(t) ? this.T(t) : this._(t);
    }
    k(t)
    {
    ...
    _(t)
    {
        this._$AH !== A && d(this._$AH) ? this._$AA.nextSibling.data = t : this.$(r.createTextNode(t)),
        this._$AH = t;
    }
    g(t)
    {
    ...
    T(t)
    {
        ...
        let s,
            e = 0;
        for (const o of t)
            e === i.length ? i.push(s = new R(this.k(u()), this.k(u()), this, this.options)) : s = i[e],
            s._$AI(o),
            e++;
...
class k {
    constructor(t, i, s, e, o)
    {
        ...
        this._$AM = e,
        this.options = o,
        s.length > 2 || "" !== s[0] || "" !== s[1] ? (this._$AH = Array(s.length - 1).fill(new String), this.strings = s) : this._$AH = A;
    }
    get tagName()
    {
...
null == B || B(N, R),
(null !== (t = i.litHtmlVersions) && void 0 !== t ? t : i.litHtmlVersions = []).push("2.7.5");
const D = (t, i, s) => {
    var e,
        o;
...
class s extends u$1 {
    ...
    update(t)
    {
        ...
        super.update(t),
        this._$Do = D(i, this.renderRoot, this.renderOptions);
    }
    connectedCallback()
    {
        var t;
...
class EmojiReaction extends s {
  ...
  `
    ...
    <!-- container -->
    <div style="flex-wrap: nowrap; max-width: 100%; display: flex; gap: 0.375rem; height: 1.5rem;" class="${
        ...
        this?.theme === 'dark' || (this?.theme === 'system' && system_theme === 'dark') ? 'container-dark' : 'container'}">
      <!-- 灰色笑脸 -->
      <div style="position: relative; user-select: none; display: flex;">
        <div id="start-smile" @click="${

        this._showAvailable}"
          style="display: flex; align-self: center; border-radius: 800px; width: 1rem; height: 1rem; line-height: 1rem; padding: 0.25rem;">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" id="start-smile-svg" style="cursor: pointer;">
            <path
        ...
        <div class="anim-scale-in reaction-available-popup" @click=${
        ...
        this._closePopup} style="display: ${this.showAvailable ? 'flex' : 'none'}; user-select: none; position: absolute; top: -3rem; font-size: 0.875rem; border-radius: 0.375rem; padding: 0 0.125rem;">
          <!-- reactions available -->
          ${
