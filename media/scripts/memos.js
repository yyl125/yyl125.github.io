...
.bb-load button{padding:1.25rem;width:100%;background:0 0;letter-spacing:.8rem;font-size:.8rem;}
...
.db-card-cate{position: absolute;top:0;right:0;background:#f99b01;padding:1px 8px;font-size:small;border-radius:0 3px 0 3px;text-transform:uppercase;}
...
let load = '<div class="bb-load"><button class="load-btn button-load">正在加载</button></div>'
...
async function fetchNeoDB(url) {
  ...
  let ratingDisplay = dbFetch.rating !== null ? `${dbFetch.rating}` : "评分人数不足";
