...
const allCSS = `
#bber{margin-top:1rem;width:auto!important;}
...
.bb-timeline .bb-item,.bb-load button{border:1px solid rgba(0, 0, 0, 0.125);border-radius:.25rem;box-shadow: 0 6px 14px 0 rgba(0,0,0,.04);}
.bb-timeline .bb-item{padding:.6rem 1rem .6rem;font-size:16px;background-color:rgb(250, 249, 247);}
.bb-load button{padding:10px 30px;width:100%;background:0 0;letter-spacing:.8rem;font-size:.8rem;}
...
.db-card-cate{position: absolute;top:0;right:0;background:#f99b01;padding:1px 8px;font-size:small;font-style:italic;border-radius:0 3px 0 3px;text-transform:capitalize;}
...
async function updateHTMl(data){
  ...
  for(let i=0;i < data.length;i++){
      ...
      let emojiReaction = `<emoji-reaction theme="system" class="reaction" reacttargetid="${memosIdNow+'memo-'+bbID}" style="line-height:normal;display:inline-flex;"></emoji-reaction>`
      let datacountDOM = ""
