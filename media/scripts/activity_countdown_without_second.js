function leftTimer(year, month, day, hour, minute) {
  ...
  document.getElementsByClassName("activityHour")[0].innerHTML = hours + " 小时";
  document.getElementsByClassName("activityMinute")[0].innerHTML = minutes + " 分钟";
  }
}
...
// 在这设置年月日时分
let a = setInterval("leftTimer(2026,11,19,0,0)", 1000);